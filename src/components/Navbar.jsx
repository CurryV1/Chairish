...
//         {/* Right Side: Search Bar and Secondary Links */}
//         {/* Responsive: Center aligned on small screens, end aligned on medium and up */}
...
//               <button
//                 type="submit"
//                 className="bg-yellow-500 text-white rounded-r px-4 py-1 hover:bg-amber-600"
//               >
//                 Search
//               </button>
//             </form>
