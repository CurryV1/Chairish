...
// src/server.js (or server.js in your project root)
// import express from "express";
// import cors from "cors";
// import sqlite3 from "sqlite3";
// import flash from "express-flash";
...
// // Serve static files from the built front-end (assuming build output is in "dist")
// app.use(express.static(path.join(__dirname, "dist")));

// // Catch-all route: send index.html for any unknown route (to support client-side routing)
// app.get("*", (req, res) => {
...
// // Update the database connection to use an absolute path
...
// src/server.js (or server.js in your project root, if it's in src, adjust paths accordingly)
// import express from "express";
// import cors from "cors";
// import sqlite3 from "sqlite3";
// import flash from "express-flash";
...
// // Connect to your SQLite database with an adjusted path (move one directory up)
// const dbPath = path.join(__dirname, "ecommerce.db");
// const db = new sqlite.Database(dbPath, (err) => {
//   if (err) {
//     console.error("Error opening database", err);
...
// // Connect to your SQLite database (database is in the root)
// const dbPath = path.join(__dirname, "ecommerce.db");
// const db = new sqlite.Database(dbPath, (err) => {
//   if (err) {
//     console.error("Error opening database", err);
