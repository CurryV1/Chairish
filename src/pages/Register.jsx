...
// // If you have an AuthContext for user registration:
...
//   const [successMessage, setSuccessMessage] = useState("");
//   const navigate = useNavigate();
//   // const { setUser } = useContext(AuthContext); // Use if using AuthContext
...
//       // Optionally, store the first name in global context:
//       // const firstName = name.trim().split(" ")[0];
//       // setUser({ firstName });

//       setSuccessMessage("Registration successful! Redirecting to login...");

//       // Redirect to login after 2 seconds if not using a callback
//       setTimeout(() => {
//         navigate("/account");
//       }, 2000);
//     } catch (err) {
